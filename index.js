...
// // // codea debajo de este comentario la solucion al ejercicio
// const multiplicación = numbers.reduce((acc, elemento) => {
// 	return acc * elemento;
// });
...
// const libros = librosDeJS.reduce((acc, elemento) => {
...
// codear acá la solución del ejercicio
// const datosNuevos = datos.filter((elemento) => {
// 	return elemento >= 0;
// });
